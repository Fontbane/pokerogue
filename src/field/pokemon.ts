...
export class PokemonSummonData {
  ...
  isDefault(): boolean {
    return (isNullOrUndefined(this.statStages) || this.statStages.every(s=>s === 0)) && (isNullOrUndefined(this.stats) || this.stats.every(s=>s === 0)) && isNullOrUndefined(this.moveQueue) && isNullOrUndefined(this.moveset);
  }
}
