...
export class ForceSwitchOutAttr extends MoveEffectAttr {
  ...
  getSwitchOutCondition(): MoveConditionFunc {
	...
	//U-turn et al should not switch a wild mon out, including status moves that don't target the user, but a player's Dragon Tail can
        if (this.user && (move.category !== MoveCategory.STATUS || move.moveTarget !== MoveTarget.USER || (move.category == MoveCategory.STATUS && move.moveTarget == MoveTarget.USER && user.scene.currentBattle?.double) ))
          return false;
